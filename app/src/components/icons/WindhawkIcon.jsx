function WindhawkIcon({ size = 16, className }) {
  return (
    <svg width={size} height={size} viewBox="0 0 750 750" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden="true">
