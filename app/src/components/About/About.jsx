        ...
        <div className="about-overlay" onClick={handleBackdropClick}>
            <div className="about-card">
                ...
                <div className="about-icon">
                    <img src={kalamIcon} alt="Kalam" />
                </div>

                <h2 className="about-name">Kalam</h2>
                <p className="about-version">Version {version}</p>

                <button
                    className={`about-update-btn ${checkStatus}`}
                    onClick={handleCheck}
                ...
                <div className="about-divider">or</div>

                <div className="about-links">
                    <button
                        className="about-link"
                        onClick={() => open("https://comp-tech-guy.github.io/Kalam/")}
                    >
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <button
                        className="about-link"
                        onClick={() => open("https://discord.gg/EApJY56M8h")}
                    >
                    ...
                    <button
                        className="about-link"
                        onClick={() => open("https://github.com/Comp-Tech-Guy/Kalam")}
                    >
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
